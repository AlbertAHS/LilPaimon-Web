            ...
            <div class="d-flex justify-content-center py-4">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4"><?php echo $row['nama']; ?></h5>
                  </div>

                  <form class="row g-3 needs-validation" novalidate>

                    <div class="col-12 ">
                    <?php echo '<img src="assets/img/'.$row['gambar'].'"class="img-fluid rounded-start" >' ?>
                    </div>
