...
<body>
              ...
              <div class="d-flex justify-content-center">
                <p3>Tanggal <?php echo date('Y/m/d') . '<br>'; ?></p3>
              </div>
              <div class="d-flex justify-content-center">
                <p3>Printed By <?php echo $_SESSION['username']; ?></p3>
              </div>
...
<table class="table">
        ...
        if (mysqli_num_rows($result) > 0) {
          ...
          <tr>
            ...
            <td><?php echo number_format($row['harga'],2,',','.') . " Rupiah"; ?></td>
            <td><?php echo '<img src="assets/img/'.$row['gambar'].'"class="img-fluid rounded-start" >' ?></td>
