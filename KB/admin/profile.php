...
<body>
  ...
  <a href="tambahprofile.php"><button type="button" class="btn btn-success">Add</button></a>
  <a href="printprofile.php"><button type="button" class="btn btn-success">Print</button></a>
    ...
    <table class="table">
        ...
        if (mysqli_num_rows($result) > 0) {
          ...
          <tr>
            ...
            <td><a href="editprofile.php?uid= <?php echo $row['uid']; ?> "><button type="button" class="btn btn-warning">Edit</button> </a></td>
            <td><a href="deleteprofile.php?uid= <?php echo $row['uid']; ?> "><button type="button" class="btn btn-danger">Delete</button></a></td>
