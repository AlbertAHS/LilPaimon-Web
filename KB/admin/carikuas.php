...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="search-bar">
      <form class="search-form d-flex align-items-center" method="POST" action="carikuas.php">
...
$sql = "SELECT * FROM kuas WHERE nama LIKE '%$cari%'";
...
<div class="pagetitle">
  ...
  <nav>
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active">Produk Kuas</li>
    </ol>
  </nav>
</div><!-- End Page Title --> 

  <a href="tambahkuas.php"><button type="button" class="btn btn-success">Add</button></a>
    ...
    <table class="table">
        ...
        if (mysqli_num_rows($result) > 0) {
          ...
          <tr>
            ...
            <td><a href="editkuas.php?id= <?php echo $row['id']; ?> "><button type="button" class="btn btn-warning">Edit</button> </a></td>
            <td><a href="deletekuas.php?id= <?php echo $row['id']; ?> "><button type="button" class="btn btn-danger">Delete</button></a></td>
