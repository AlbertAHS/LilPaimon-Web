...
$idLog = $_GET['idLog'];
$sql = "SELECT * FROM log WHERE idLog='" . $idLog . "'";
  ...
  <main id="main" class="main">
    ...
    <section class="section dashboard">
      <div class="row">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Produk Terjual <?php echo $row['bulan'];?></h5>
              <div class="filter">
                  ...
                  new Chart(document.querySelector('#produk'), {
                    ...
                    data: {
                      ...
                      datasets: [{
                        ...
                        <?php $sql = mysqli_query($conn, "SELECT cat FROM `log` WHERE idLog = $idLog"); ?>
                        <?php $cat = mysqli_fetch_assoc($sql); ?>
                        <?php $sql = mysqli_query($conn, "SELECT kuas FROM `log`WHERE idLog = $idLog"); ?>
                        <?php $kuas = mysqli_fetch_assoc($sql); ?>
                        <?php $sql = mysqli_query($conn, "SELECT kanvas FROM `log`WHERE idLog = $idLog"); ?>
                        <?php $kanvas = mysqli_fetch_assoc($sql);?>
                        data: [<?php echo $cat['cat']; ?>, <?php echo $kuas['kuas']; ?>, <?php echo $kanvas['kanvas']; ?>],
                        backgroundColor: [
                          'rgb(255, 99, 132)',
                          'rgb(54, 162, 235)',
                          'rgb(255, 205, 86)'
