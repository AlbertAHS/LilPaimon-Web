...
<div class="pagetitle">
  ...
  <nav>
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item"><a href= "cat.php">Produk Cat</a></li>
...
<div id="section" class="produk">
    <div class="container">
        <div class="row justify-content-center">
          ...
          <form action="ubahcat.php?id=<?php echo $row['id']; ?>" method="post" class="row g-3 needs-validation" novalidate>
          <div class="col-md-8">
                <div class="card-body">
