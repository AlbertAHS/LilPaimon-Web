...
<div class="container">
 ...
 <form action="addprofile.php" method= "post">
        <!-- Card with an image on left -->
          ...
          <div class="col-md-8">
            <div class="card-body">
              <h5 class="card-title"><label for="email" class="form-label">E-mail</label>
              <input type="text" class="form-control" id="email" name="email">
              <p class="card-text"><label for="nama" class="form-label">Nama</label>
              <input type="text" class="form-control" id="inputjudul" name= "nama"></p>
              ...
              <input type="text" class="form-control" id="gambar" name= "gambar"></p>
              ...
              <input type="text" class="form-control" id="alamat" name= "alamat"></p>
              <p class="card-text"><label for="telp" class="form-label">No.Telp</label>
              <input type="text" class="form-control" id="telp" name= "telp"></p>
