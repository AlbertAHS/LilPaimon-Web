...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="search-bar">
      <form class="search-form d-flex align-items-center" method="POST" action="cariartikel.php">
  ...
  <main id="main" class="main">
    ...
    <div class="container">
        ...
        <div class="row mb-5 pt-4">
            ...
            <a href="printartikel.php"><button type="button" class="btn btn-success rounded-pill">Print</button></a>
        </div>
    </div>  
