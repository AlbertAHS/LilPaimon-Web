...
<body>
  ...
  <div id="section" class="produk">
    <div class="container">
     ...
     <form action="editartikel.php?idArtikel=<?php echo $row["idArtikel"];?>" method= "post">
            <!-- Card with an image on left -->
          <div class="card mb-4">
            <div class="row g-0">
              <div class="col-md-4">
              
             <input type="submit" value="Edit Image" name="uploadimage">

            </div>
              <div class="col-md-8">
                <div class="card-body">
                  <h5 class="card-title"><label for="inputurl" class="form-label">URL</label>
                  <input type="text" class="form-control" id="inputurl" name="inputurl" value="<?php echo $row["url"]; ?>">
                  <p class="card-text"><label for="inputjudul" class="form-label">Judul Artikel</label>
                  <input type="text" class="form-control" id="inputjudul" name= "inputjudul" value="<?php echo $row["judul"]; ?>"></p>
                  <p class="card-text"><label for="inputpengantar" class="form-label" >Pengantar</label>
                  <input type="text" class="form-control" id="inputpengantar" name= "inputpengantar" value="<?php echo $row["pengantar"]; ?>" style="height: 100px;"></p>
