...
<div class="pagetitle">
  ...
  <nav>
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item"><a href= "kuas.php">Produk Kuas</a></li>
...
<div id="section" class="produk">
    <div class="container">
        <div class="row justify-content-center">
          ...
          <form action="ubahkuas.php?id=<?php echo $row['id']; ?>" method="post" class="row g-3 needs-validation" novalidate>
          <div class="col-md-8">
                <div class="card-body">
                  ...
                  <a href= "kuas.php"><button type="button" class="btn btn-danger rounded-pill">Cancel</button></a>
                </div>
              </div>
            </form>
            </div>
