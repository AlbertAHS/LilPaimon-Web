...
header( "Location: http://localhost/pemrogamanweb/KB/login.html" );
  ...
  $sql = "SELECT * FROM kanvas WHERE id='" . $id . "'";
...
<div class="pagetitle">
  ...
  <nav>
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item"><a href= "kanvas.php">Produk Kanvas</a></li>
...
<div id="section" class="produk">
    <div class="container">
        <div class="row justify-content-center">
          ...
          <form action="ubahkanvas.php?id=<?php echo $row['id']; ?>" method="post" class="row g-3 needs-validation" novalidate>
          <div class="col-md-8">
                <div class="card-body">
                  ...
                  <input type="text" class="form-control" id="harga" name= "harga" value="<?php echo $row["harga"]; ?>"></p>
                  <p class="card-text"><label for="gambar" class="form-label" >Gambar</label>
                  <input type="text" class="form-control" id="gambar" name= "gambar" value="<?php echo $row["gambar"]; ?>"></p>
                  <p class="card-text"><label for="deskripsi" class="form-label" >Deskripsi</label>
                  <input type="text" class="form-control" id="deskripsi" name= "deskripsi" value="<?php echo $row["deskripsi"]; ?>" style="height: 100px;"></p>

                  <button type="submit" class="btn btn-success rounded-pill" name= "save">Save</button>
                  <a href= "kanvas.php"><button type="button" class="btn btn-danger rounded-pill">Cancel</button></a>
                </div>
              </div>
            </form>
            </div>
