...
<head>
  ...
  <title>LilPaimon Register Page</title>
...
<body>
    ...
    if (isset($_REQUEST['register'])) {
      ...
      $query    = "INSERT into profile (username, password, email)
      VALUES ('$username', '" . $password . "', '$email')";
      $result = mysqli_query($con, $query);

      if($result) header("Location: registered.php");
    }
    ?>
  <main>
    <div class="container">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Join Paimon in Art Adventure</p>
                  </div>
                  ...
                  <form class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12">
                      <label for="yourUsername" class="form-label">Pick a New Username</label>
